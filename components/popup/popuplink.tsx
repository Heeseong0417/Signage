    ...
    isOpen ==="1"&&  (
      ...
      >
        <Dialog
          ...
          className="z-[9999] fixed top-[30%] left-[5%] lg:left-[37.5%] w-[90%] lg:w-[25%] min-w-[20rem] leading-10  max-w-full p-0 m-0 bg-white rounded-lg shadow-lg flex flex-col overflow-hidden"
        ...
        >
          ...
          <div className="p-6 w-[calc(100%_-3rem)] flex flex-col items-center justify-center text-center">
            <h2 className="text-lg font-bold mb-4 whitespace-pre-line">{content}</h2>
